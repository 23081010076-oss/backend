...
classDiagram
    ...
    %% Relationships - E-Learning Module
    USERS "1" --> "*" ENROLLMENTS : enrolls
    COURSES "1" --> "*" ENROLLMENTS : has
    COURSES "1" --> "*" COURSE_CURRICULUMS : contains
    ENROLLMENTS "1" --> "*" CURRICULUM_PROGRESS : tracks
    COURSE_CURRICULUMS "1" --> "*" CURRICULUM_PROGRESS : progress_in

    %% Relationships - Mentoring Module
    USERS "1" --> "*" MENTORING_SESSIONS : mentors/attends

    %% Relationships - Scholarship Module
    USERS "1" --> "*" SCHOLARSHIP_APPLICATIONS : applies
    SCHOLARSHIPS "1" --> "*" SCHOLARSHIP_APPLICATIONS : receives

    %% Relationships - Finance Module
    USERS "1" --> "*" TRANSACTIONS : makes
    USERS "1" --> "*" SUBSCRIPTIONS : subscribes
```
