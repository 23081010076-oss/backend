...
|
| Untuk backward compatibility, routes tanpa /v1/ juga tetap tersedia
| Tapi disarankan menggunakan /v1/ untuk integrasi baru
|
*/

// ==========================================================================
// WEBHOOK ROUTES (Public - tanpa versioning)
// ==========================================================================
...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    // Authentication endpoints (dengan Rate Limiting)
    ...
    Route::middleware('auth:api')->group(function () {
        ...
        // CORPORATE CONTACT MANAGEMENT (Admin)
        Route::middleware('role:admin')->group(function () {
...
// ==========================================================================
// BACKWARD COMPATIBILITY ROUTES (tanpa /v1/ prefix)
// ==========================================================================
// Untuk mendukung client lama yang belum update ke /v1/
// Disarankan untuk migrate ke /v1/ untuk integrasi baru
